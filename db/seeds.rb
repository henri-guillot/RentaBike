...
pif = User.new(email: 'pif@gmail.com', password: 'password')
...
tudal = User.new(email: 'tudal@gmail.com', password: 'password')
tudal.save

luka = User.new(email: 'luka@gmail.com', password: 'password')
